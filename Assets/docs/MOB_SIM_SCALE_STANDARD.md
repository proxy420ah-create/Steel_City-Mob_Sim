...
The Mob Sim has its own micro universe where NPC wise guys (0.64m tall) are the "humans." Everything in the city is proportional to this scale, not real-world scale. This document defines the standard for all Mob Sim objects.
